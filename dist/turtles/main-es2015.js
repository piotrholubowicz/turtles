...
const routes = [
    ...
    { path: 'board/:id', component: _board_board_component__WEBPACK_IMPORTED_MODULE_3__["BoardComponent"] },
    { path: 'hand/:id/:player', component: _player_player_component__WEBPACK_IMPORTED_MODULE_4__["PlayerComponent"] },
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 3, vars: 0, consts: [["href", "http://www.freepik.com", 2, "color", "#eeeeee", "font-size", "8pt", "float", "right"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _player_player_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./player/player.component */ "./src/app/player/player.component.ts");
...
/* harmony import */ var _color_picker_dialog_color_picker_dialog_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./color-picker-dialog/color-picker-dialog.component */ "./src/app/color-picker-dialog/color-picker-dialog.component.ts");
...
/* harmony import */ var _image_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./image.service */ "./src/app/image.service.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [{ provide: _angular_common__WEBPACK_IMPORTED_MODULE_1__["APP_BASE_HREF"], useValue: '/turtles/' }, _game_service__WEBPACK_IMPORTED_MODULE_9__["GameService"], _in_memory_data_service__WEBPACK_IMPORTED_MODULE_5__["InMemoryDataService"], _image_service__WEBPACK_IMPORTED_MODULE_16__["ImageService"]], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"],
        ...
        _player_player_component__WEBPACK_IMPORTED_MODULE_12__["PlayerComponent"],
        _card_card_component__WEBPACK_IMPORTED_MODULE_13__["CardComponent"],
        _color_picker_dialog_color_picker_dialog_component__WEBPACK_IMPORTED_MODULE_14__["ColorPickerDialogComponent"],
        _page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_15__["PageNotFoundComponent"],
        _game_over_game_over_component__WEBPACK_IMPORTED_MODULE_17__["GameOverComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                ...
                providers: [{ provide: _angular_common__WEBPACK_IMPORTED_MODULE_1__["APP_BASE_HREF"], useValue: '/turtles/' }, _game_service__WEBPACK_IMPORTED_MODULE_9__["GameService"], _in_memory_data_service__WEBPACK_IMPORTED_MODULE_5__["InMemoryDataService"], _image_service__WEBPACK_IMPORTED_MODULE_16__["ImageService"]],
...
/* harmony import */ var _game_engine__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../game-engine */ "./src/app/game-engine.ts");
/* harmony import */ var _game_over_game_over_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../game-over/game-over.component */ "./src/app/game-over/game-over.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _game_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../game.service */ "./src/app/game.service.ts");
/* harmony import */ var _image_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../image.service */ "./src/app/image.service.ts");
...
const _c0 = function (a0) { return { active_player: a0 }; };
function BoardComponent_div_5_span_4_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span", 15);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} if (rf & 2) {
    const p_r20 = ctx.$implicit;
    const game_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().ngIf;
...
function BoardComponent_div_5_img_8_Template(rf, ctx) { if (rf & 1) {
...
function BoardComponent_div_5_img_11_Template(rf, ctx) { if (rf & 1) {
...
function BoardComponent_div_5_img_13_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "img", 17);
} if (rf & 2) {
...
const _c1 = function (a1, a2) { return ["/hand", a1, a2]; };
function BoardComponent_div_5_a_18_Template(rf, ctx) { if (rf & 1) {
...
class BoardComponent {
    constructor(route, router, service, imageService, modalService) {
        this.route = route;
        this.router = router;
    ...
    ngOnInit() {
        this.game$ = this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["switchMap"])((params) => {
            return this.service.getGame(+params.get('id')).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["tap"])((game) => {
                if (game.winner) {
                    this.gameOver(game).then((result) => {
                        if (result === 'onemore') {
                            console.log('once more!');
                            this.service
                                .addGame(_game_engine__WEBPACK_IMPORTED_MODULE_3__["GameEngine"].createGame(_game_engine__WEBPACK_IMPORTED_MODULE_3__["GameEngine"].shuffle([...game.players])), game)
                                .subscribe((newGame) => {
    ...
    left(game, color) {
        ...
        const fieldAndPos = _game_engine__WEBPACK_IMPORTED_MODULE_3__["GameEngine"].findPosition(game, color);
        if (fieldAndPos[0] === 0) {
    ...
    gameOver(game) {
        const modalRef = this.modalService.open(_game_over_game_over_component__WEBPACK_IMPORTED_MODULE_4__["GameOverComponent"]);
...
BoardComponent.ɵfac = function BoardComponent_Factory(t) { return new (t || BoardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_game_service__WEBPACK_IMPORTED_MODULE_6__["GameService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_image_service__WEBPACK_IMPORTED_MODULE_7__["ImageService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbModal"])); };
BoardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: BoardComponent, selectors: [["app-board"]], decls: 7, vars: 3, consts: [[1, "container-fluid"], [1, "row"], [1, "col"], ["href", "/"], ["src", "/assets/img/title.png"], [4, "ngIf"], [1, "players"], [3, "ngClass", 4, "ngFor", "ngForOf"], [1, "col-12"], ["src", "/assets/img/board.png", 1, "board"], ["class", "meeple", 3, "src", "left", "top", "z-index", 4, "ngFor", "ngForOf"], [1, "row", "card-row"], [1, "col-6"], ["class", "movecard", 3, "src", "left", 4, "ngFor", "ngForOf"], ["type", "button", "class", "btn btn-secondary btn-player", 3, "routerLink", 4, "ngFor", "ngForOf"], [3, "ngClass"], [1, "meeple", 3, "src"], [1, "movecard", 3, "src"], ["type", "button", 1, "btn", "btn-secondary", "btn-player", 3, "routerLink"]], template: function BoardComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](BoardComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }, { type: _game_service__WEBPACK_IMPORTED_MODULE_6__["GameService"] }, { type: _image_service__WEBPACK_IMPORTED_MODULE_7__["ImageService"] }, { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbModal"] }]; }, null); })();
...
class CardComponent {
    constructor(modalService, imageService) {
        this.modalService = modalService;
        this.imageService = imageService;
...
CardComponent.ɵfac = function CardComponent_Factory(t) { return new (t || CardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_image_service__WEBPACK_IMPORTED_MODULE_3__["ImageService"])); };
CardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CardComponent, selectors: [["app-card"]], inputs: { game: "game", cardIdx: "cardIdx", enabled: "enabled" }, outputs: { played: "played" }, decls: 2, vars: 1, consts: [[3, "click"], [1, "movecard", 3, "src"]], template: function CardComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "a", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CardComponent_Template_a_click_0_listener() { return ctx.play(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CardComponent, [{
    ...
    }], function () { return [{ type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"] }, { type: _image_service__WEBPACK_IMPORTED_MODULE_3__["ImageService"] }]; }, { game: [{
...
function ColorPickerDialogComponent_div_12_Template(rf, ctx) { if (rf & 1) {
...
class ColorPickerDialogComponent {
    constructor(activeModal, formBuilder, imageService) {
...
ColorPickerDialogComponent.ɵfac = function ColorPickerDialogComponent_Factory(t) { return new (t || ColorPickerDialogComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbActiveModal"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_image_service__WEBPACK_IMPORTED_MODULE_4__["ImageService"])); };
ColorPickerDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ColorPickerDialogComponent, selectors: [["app-color-picker-dialog"]], inputs: { colors: "colors" }, decls: 16, vars: 3, consts: [[1, "modal-header"], [1, "modal-title"], ["type", "button", "aria-label", "Close", 1, "close", 3, "click"], ["aria-hidden", "true"], [3, "formGroup", "ngSubmit"], [1, "modal-body"], [1, "container"], [1, "form-row"], ["class", "col", 4, "ngFor", "ngForOf"], [1, "modal-footer"], [1, "btn", "btn-primary", 3, "disabled"], [1, "col"], ["type", "radio", "name", "color", "formControlName", "color", "required", "", 1, "form-check-input", 3, "id", "value"], [1, "form-check-label", 3, "for"], [2, "width", "80%", 3, "src"]], template: function ColorPickerDialogComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "h4", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "Wybierz \u017C\u00F3\u0142wia");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "button", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ColorPickerDialogComponent_Template_button_click_3_listener() { return ctx.activeModal.dismiss("Cross click"); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ColorPickerDialogComponent_Template_form_ngSubmit_6_listener() { return ctx.submitForm(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "div", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "div", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](9, "p");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](10, "Kt\u00F3rego \u017C\u00F3\u0142wia chcesz przesun\u0105\u0107?");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ColorPickerDialogComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
    ...
    }], function () { return [{ type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbActiveModal"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _image_service__WEBPACK_IMPORTED_MODULE_4__["ImageService"] }]; }, { colors: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }] }); })();
...
class GameEngine {
    static createGame(players) {
        ...
        const turtles = [_game__WEBPACK_IMPORTED_MODULE_0__["Color"].BLUE, _game__WEBPACK_IMPORTED_MODULE_0__["Color"].GREEN, _game__WEBPACK_IMPORTED_MODULE_0__["Color"].PURPLE, _game__WEBPACK_IMPORTED_MODULE_0__["Color"].RED, _game__WEBPACK_IMPORTED_MODULE_0__["Color"].YELLOW];
        GameEngine.shuffle(turtles);
        const deck = Array.from(_game__WEBPACK_IMPORTED_MODULE_0__["ALL_CARDS"].keys()); // shallow copy
        GameEngine.shuffle(deck);
        const playersToTurtles = {};
        players.forEach((player) => (playersToTurtles[player] = turtles.pop()));
        const playersToHands = {};
    ...
    static defineColors(game, cardIdx) {
        const color = _game__WEBPACK_IMPORTED_MODULE_0__["ALL_CARDS"][cardIdx].color;
        switch (color) {
            ...
            case _game__WEBPACK_IMPORTED_MODULE_0__["Color"].ANY:
                let colors = [_game__WEBPACK_IMPORTED_MODULE_0__["Color"].BLUE, _game__WEBPACK_IMPORTED_MODULE_0__["Color"].GREEN, _game__WEBPACK_IMPORTED_MODULE_0__["Color"].PURPLE, _game__WEBPACK_IMPORTED_MODULE_0__["Color"].RED, _game__WEBPACK_IMPORTED_MODULE_0__["Color"].YELLOW];
    ...
    static playCard(game, cardIdx, color) {
        if (game.winner) {
    ...
    static makeMove(game, distance, color) {
        const fieldAndPos = GameEngine.findPosition(game, color);
        const field = fieldAndPos[0];
        const pos = fieldAndPos[1];
    ...
    static gameOver(game) {
        ...
        for (let field = game.board.length - 1; field >= 0; field--) {
            for (const color of game.board[field]) {
                const player = Object.keys(game.colors).find((p) => game.colors[p] === color);
                if (player) {
                    game.winner = player;
    ...
    static findPosition(game, color) {
        let field = 0;
        let pos = 0;
...
GameOverComponent.ɵfac = function GameOverComponent_Factory(t) { return new (t || GameOverComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbActiveModal"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_image_service__WEBPACK_IMPORTED_MODULE_2__["ImageService"])); };
GameOverComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: GameOverComponent, selectors: [["app-game-over"]], inputs: { winner: "winner", color: "color" }, decls: 22, vars: 2, consts: [[1, "modal-header"], [1, "modal-title"], ["type", "button", "aria-label", "Close", 1, "close", 3, "click"], ["aria-hidden", "true"], [1, "modal-body"], [1, "container"], [1, "row"], [1, "col"], [1, "col-4"], [1, "turtlecard", 3, "src"], [1, "modal-footer"], [1, "btn", "btn-secondary", 3, "click"], [1, "btn", "btn-primary", 3, "click"]], template: function GameOverComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "h4", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "Koniec gry");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "button", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function GameOverComponent_Template_button_click_3_listener() { return ctx.activeModal.dismiss("Cross click"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "span", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "\u00D7");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function GameOverComponent_Template_button_click_18_listener() { return ctx.activeModal.close("onemore"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](19, " Jeszcze raz! ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](20, "button", 12);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function GameOverComponent_Template_button_click_20_listener() { return ctx.activeModal.close("OK"); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GameOverComponent, [{
    ...
    }], function () { return [{ type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbActiveModal"] }, { type: _image_service__WEBPACK_IMPORTED_MODULE_2__["ImageService"] }]; }, { winner: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }], color: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }] }); })();
...
class GameService {
    ...
    getGames() {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["timer"])(0, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((_) => this.fetchUrl(url, 'getGames')), // a new http request on every tick
    ...
    getGame(id) {
        ...
        delete this.cache[url];
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["timer"])(0, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((_) => this.fetchUrl(url, `getGame id=${id}`)), // a new http request on every tick
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["shareReplay"])({
            bufferSize: 1,
            refCount: true,
        }) // create a new Subject, which will act as a proxy
    ...
    fetchUrl(url, operation) {
        const headers = this.cache[url] ? this.headers.set('If-None-Match', this.cache[url]) : this.headers;
        return this.http
            .get(url, { observe: 'response', headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((resp) => (this.cache[url] = resp.headers.get('Etag'))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((resp) => resp.body), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError(operation)));
    }
    //////// Save methods //////////
    /** POST: add a new game to the server */
    addGame(game, currentGame) {
        const url = currentGame ? `${this.gamesUrl}?prevGame=${currentGame.id}` : this.gamesUrl;
        return this.http
            .post(url, game, { headers: this.headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((newGame) => console.log(`added game w/ id=${newGame.id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((g) => console.log(g)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('addGame')));
    }
    ...
    deleteGame(game) {
        ...
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((_) => console.log(`deleted game id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('deleteHero')));
    }
    /** PUT: update the game on the server */
    updateGame(game) {
        const url = `${this.gamesUrl}/${game.id}`;
        console.log(game);
        return this.http.put(url, game, { headers: this.headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((_) => console.log(`updated game id=${game.id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('updateGame')));
    }
    /**
     ...
     */
    handleError(operation = 'operation', fallback = rxjs__WEBPACK_IMPORTED_MODULE_2__["EMPTY"]) {
        return (error) => {
            if (error.status === 304) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ALL_CARDS", function() { return ALL_CARDS; });
var Color;
(function (Color) {
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _game_engine__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../game-engine */ "./src/app/game-engine.ts");
...
function GamesComponent_div_15_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function GamesComponent_div_15_div_1_Template_button_click_6_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r11); const game_r9 = ctx.$implicit; const ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2); return ctx_r10.delete(game_r9); });
...
function GamesComponent_div_15_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
...
function GamesComponent_ng_template_17_Template(rf, ctx) { if (rf & 1) {
...
class GamesComponent {
    ...
    ngOnInit() {
        this.games$ = this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["switchMap"])((params) => {
    ...
    add(playersInput) {
        ...
        const game = _game_engine__WEBPACK_IMPORTED_MODULE_2__["GameEngine"].createGame(players);
        if (game) {
...
GamesComponent.ɵfac = function GamesComponent_Factory(t) { return new (t || GamesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_game_service__WEBPACK_IMPORTED_MODULE_3__["GameService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"])); };
GamesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: GamesComponent, selectors: [["app-game-list"]], decls: 60, vars: 4, consts: [[1, "container"], [1, "row"], [1, "col"], ["href", "/"], ["src", "/assets/img/title.png"], [1, "col-6"], [1, "col-10"], [4, "ngIf", "ngIfElse"], ["noGames", ""], [1, "form-group", "row"], [1, "col-2", "col-form-label"], [1, "form-control"], ["player1", ""], ["player2", ""], ["player3", ""], ["player4", ""], ["player5", ""], ["type", "submit", 1, "btn", "btn-light", 3, "click"], ["class", "btn-group", "role", "group", "style", "width: 100%; margin-top: 5%;", 4, "ngFor", "ngForOf"], ["role", "group", 1, "btn-group", 2, "width", "100%", "margin-top", "5%"], [1, "input-group-prepend"], [1, "input-group-text"], ["type", "button", 1, "btn", "btn-light", "game", 2, "width", "80%", 3, "routerLink"], ["type", "button", "title", "delete game", 1, "btn", "btn-secondary", 3, "click"]], template: function GamesComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](8, "Wybierz istniej\u0105c\u0105 gr\u0119 lub stw\u00F3rz now\u0105.");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function GamesComponent_Template_button_click_54_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r12); const _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](28); const _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](34); const _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](40); const _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](46); const _r7 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](52); ctx.add([_r3.value, _r4.value, _r5.value, _r6.value, _r7.value]); _r3.value = ""; _r4.value = ""; _r5.value = ""; _r6.value = ""; return _r7.value = ""; });
        ...
        var tmp_0_0 = null;
        const currVal_0 = ((tmp_0_0 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](16, 2, ctx.games$)) == null ? null : tmp_0_0.length) > 0;
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](15);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", currVal_0)("ngIfElse", _r1);
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ɵangular_packages_forms_forms_y"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["NgControlStatusGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["NgForm"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterLink"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["AsyncPipe"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2dhbWVzL2dhbWVzLmNvbXBvbmVudC5jc3MifQ== */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](GamesComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"],
        args: [{
    ...
    }], function () { return [{ type: _game_service__WEBPACK_IMPORTED_MODULE_3__["GameService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] }]; }, null); })();
...
class ImageService {
    ...
    getMoveCardPath(card) {
        if (!card) {
            return `${this.PREFIX}/card-back.png`;
        }
        const color = _game__WEBPACK_IMPORTED_MODULE_1__["Color"][card.color].toLowerCase();
        const sign = card.distance === -1 ? 'minus' : card.distance === 2 ? 'plusplus' : 'plus';
        return `${this.PREFIX}/card-${color}-${sign}.png`;
    }
    getTurtleCardPath(color) {
        const which = color !== undefined ? _game__WEBPACK_IMPORTED_MODULE_1__["Color"][color].toLowerCase() : 'back';
        return `${this.PREFIX}/turtle-card-${which}.png`;
    }
    getTurtlePath(color) {
        return `${this.PREFIX}/meeple-${_game__WEBPACK_IMPORTED_MODULE_1__["Color"][color].toLowerCase()}.png`;
    }
}
...
PageNotFoundComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PageNotFoundComponent, selectors: [["app-page-not-found"]], decls: 8, vars: 0, consts: [[1, "container"], [1, "row"], [1, "col"], ["href", "/"], ["src", "/assets/img/title.png"]], template: function PageNotFoundComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/* harmony import */ var _game__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../game */ "./src/app/game.ts");
/* harmony import */ var _game_engine__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../game-engine */ "./src/app/game-engine.ts");
/* harmony import */ var _color_picker_dialog_color_picker_dialog_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../color-picker-dialog/color-picker-dialog.component */ "./src/app/color-picker-dialog/color-picker-dialog.component.ts");
...
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/__ivy_ngcc__/fesm2015/ng-bootstrap.js");
/* harmony import */ var _image_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../image.service */ "./src/app/image.service.ts");
...
function PlayerComponent_div_5_span_6_span_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " (Ty)");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
} }
const _c0 = function (a0) { return { active_player: a0 }; };
function PlayerComponent_div_5_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    const game_r33 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]().ngIf;
...
function PlayerComponent_div_5_img_10_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "img", 18);
} }
function PlayerComponent_div_5_ng_template_11_img_0_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "img", 20);
} }
function PlayerComponent_div_5_ng_template_11_Template(rf, ctx) { if (rf & 1) {
...
function PlayerComponent_div_5_div_20_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("played", function PlayerComponent_div_5_div_20_Template_app_card_played_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r46); const ctx_r45 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](2); return ctx_r45.onPlayed($event); });
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function PlayerComponent_div_5_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function PlayerComponent_div_5_Template_img_click_15_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r49); const game_r33 = ctx.ngIf; const ctx_r48 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r48.showTurtleCard(game_r33.colors[ctx_r48.player]); });
    ...
    const game_r33 = ctx.ngIf;
    const _r36 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵreference"](12);
...
class PlayerComponent {
    constructor(route, router, service, modalService, imageService) {
        this.route = route;
        this.router = router;
        this.service = service;
        this.modalService = modalService;
    ...
    ngOnInit() {
        this.game$ = this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])((params) => {
            this.player = params.get('player');
            return this.service.getGame(+params.get('id')).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])((game) => {
    ...
    onPlayed(event) {
        const colorOptions = _game_engine__WEBPACK_IMPORTED_MODULE_4__["GameEngine"].defineColors(event.game, event.cardIdx);
    ...
    cantPlayCard() { }
    pickOneColor(colorOptions) {
        const modalRef = this.modalService.open(_color_picker_dialog_color_picker_dialog_component__WEBPACK_IMPORTED_MODULE_5__["ColorPickerDialogComponent"]);
        modalRef.componentInstance.colors = colorOptions;
        return modalRef.result;
    }
    playTheCard(game, cardIdx, color) {
        _game_engine__WEBPACK_IMPORTED_MODULE_4__["GameEngine"].playCard(game, cardIdx, color);
        console.log(`${this.player} plays ${JSON.stringify(_game__WEBPACK_IMPORTED_MODULE_3__["ALL_CARDS"][cardIdx])}`);
        this.service.updateGame(game).subscribe();
    }
    turtleCardSrc(color) {
        return this.imageService.getTurtleCardPath(color);
    }
    showTurtleCard(color) {
        this.turtleCardSrc$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["merge"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(this.turtleCardSrc(color)), Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["timer"])(2000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])((_) => Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(this.turtleCardSrc()))));
    }
}
...
PlayerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: PlayerComponent, selectors: [["app-player"]], decls: 7, vars: 3, consts: [[1, "container"], [1, "row"], [1, "col"], ["href", "/"], ["src", "/assets/img/title.png"], [4, "ngIf"], [1, "row", "top-row"], [1, "col-10"], [1, "players"], [3, "ngClass", 4, "ngFor", "ngForOf"], [1, "col-3"], ["src", "/assets/img/gameover.png", "class", "img-fluid", 4, "ngIf", "ngIfElse"], ["yourturn", ""], [1, "col-2"], [1, "turtlecard", 3, "src", "click"], [1, "turtlecard"], ["class", "col", 4, "ngFor", "ngForOf"], [3, "ngClass"], ["src", "/assets/img/gameover.png", 1, "img-fluid"], ["src", "/assets/img/yourturn.png", "class", "img-fluid", 4, "ngIf"], ["src", "/assets/img/yourturn.png", 1, "img-fluid"], [3, "cardIdx", "game", "enabled", "played"]], template: function PlayerComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](PlayerComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] }, { type: _game_service__WEBPACK_IMPORTED_MODULE_7__["GameService"] }, { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbModal"] }, { type: _image_service__WEBPACK_IMPORTED_MODULE_9__["ImageService"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! /Users/piotrhol/Documents/GitHub/turtles/src/main.ts */"./src/main.ts");
